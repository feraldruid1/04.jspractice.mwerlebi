...
let shota=document.getElementsByClassName("shota");
let akaki=document.getElementsByClassName("akaki");
let ilia=document.getElementsByClassName("ilia");
let vazha=document.getElementsByClassName("vazha");
function iliatext(){
...
shota[0].addEventListener("click",shotatext);
akaki[0].addEventListener("click",akakitext);
ilia[0].addEventListener("click",iliatext);
vazha[0].addEventListener("click",vazhatext);